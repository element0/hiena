...
#define COSMOS_HOST_SOCDIR_PATH


#define COSMOS_HOST_LOOKUPMOD_FPATH COSMOS_HOST_MODDIR_PATH "/" COSMOS_LOOKUPMOD_NAME COSMOS_MOD_SUFFIX

#define COSMOS_HOST_SVCMOD_FPATH COSMOS_HOST_MODDIR_PATH "/" COSMOS_HOST_SVCMOD_NAME COSMOS_MOD_SUFFIX
